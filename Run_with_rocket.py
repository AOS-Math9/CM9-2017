...
# t = malik # = Turtle()      # create a turtle named malik
square(t, 100)    # draw a square of size 100
square(t, 75)     # draw a square of size 75
square(t, 50)     # draw a square of size 50
square(t, 25)     # draw a square of size 25
...
mystery(t, 250)        # draw something with size = 100
